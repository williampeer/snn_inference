...
def lif_continuous_ensembles_model_dales_compliant(random_seed, N = 12):
    ...
    pop_size = int(N / 3)
    params_pop1 = {'tau_m': 2.8, 'E_L': -42., 'tau_s': 5.5}
    weights_std = 0.1
    # weights_std = 0
    ...
    params_pop2 = {'tau_m': 2.4, 'E_L': -55., 'tau_s': 4.0}
    ...
    params_pop3 = {'tau_m': 2.2, 'E_L': -70., 'tau_s': 2.6}
...
def lif_asc_continuous_ensembles_model_dales_compliant(random_seed, N = 12):
    ...
    pop_size = int(N / 3)
    params_pop1 = {'tau_m': 2.4, 'E_L': -52., 'f_I': 0.45, 'G': 0.9, 'delta_theta_s': 18., 'b_s': 0.4, 'f_v': 0.14,
                   'delta_V': 10., 'I_A': 1.2, 'tau_s': 6.0}
    weights_std = 0.1
    # weights_std = 0
    hand_coded_params_pop1 = {'preset_weights': (torch.ones((pop_size, 1)) +
                                                 (2*weights_std * torch.randn((pop_size, N))) - weights_std) *
    ...
    params_pop2 = {'tau_m': 2.1, 'E_L': -57., 'f_I': 0.35, 'G': 0.8, 'delta_theta_s': 14., 'b_s': 0.3, 'f_v': 0.14,
                   'delta_V': 12., 'I_A': 1.2, 'tau_s': 4.0}
    hand_coded_params_pop2 = {'preset_weights': (torch.ones((pop_size, 1)) +
                                                 (2*weights_std * torch.randn((pop_size, N))) - weights_std) *
    ...
    params_pop3 = {'tau_m': 1.65, 'E_L': -66., 'f_I': 0.3, 'G': 0.7, 'delta_theta_s': 18., 'b_s': 0.25, 'f_v': 0.14,
...
def lif_r_asc_continuous_ensembles_model_dales_compliant(random_seed, N = 12):
    ...
    pop_size = int(N / 3)
    params_pop1 = {'tau_m': 2.45, 'E_L': -50., 'f_I': 0.45, 'G': 0.9, 'delta_theta_s': 18., 'b_s': 0.4, 'f_v': 0.14,
                   'delta_V': 10., 'I_A': 1.2, 'tau_s': 6.0}
    weights_std = 0.1
    # weights_std = 0
    hand_coded_params_pop1 = {'preset_weights': (torch.ones((pop_size, 1)) +
    ...
    params_pop2 = {'tau_m': 2.1, 'E_L': -58., 'f_I': 0.35, 'G': 0.8, 'delta_theta_s': 14., 'b_s': 0.3, 'f_v': 0.14,
                   'delta_V': 12., 'I_A': 1.2, 'tau_s': 4.5}
    hand_coded_params_pop2 = {'preset_weights': (torch.ones((pop_size, 1)) +
                                                 (2 * weights_std * torch.randn((pop_size, N))) - weights_std) *
                                                # torch.cat([T(4*[.1]), T(4*[.43]), T(4*[0.34])])}
    ...
    params_pop3 = {'tau_m': 1.65, 'E_L': -68., 'f_I': 0.3, 'G': 0.7, 'delta_theta_s': 18., 'b_s': 0.25, 'f_v': 0.14,
...
def glif_continuous_ensembles_model_dales_compliant(random_seed, N = 12):
    ...
    pop_size = int(N / 3)
    params_pop1 = {'tau_m': 2.8, 'G': 0.8, 'E_L': -40., 'delta_theta_s': 18., 'b_s': 0.4, 'f_v': 0.14, 'delta_V': 10.,
                   'f_I': 0.45, 'I_A': 1.2, 'b_v': 0.4, 'a_v': 0.4, 'theta_inf': -8., 'tau_s': 7.0}
    weights_std = 0.1
    # weights_std = 0
    hand_coded_params_pop1 = {'preset_weights': (torch.ones((pop_size, 1)) +
                                                 (2*weights_std * torch.randn((pop_size, N))) - weights_std) *
    ...
    params_pop2 = {'tau_m': 2.2, 'G': 0.8, 'E_L': -49., 'delta_theta_s': 14., 'b_s': 0.3, 'f_v': 0.14, 'delta_V': 12.,
    ...
    params_pop3 = {'tau_m': 1.8, 'G': 0.8, 'E_L': -62., 'delta_theta_s': 18., 'b_s': 0.25, 'f_v': 0.14, 'delta_V': 12.,
...
#     np.random.seed(random_seed)
#
#     # parameter_names = ['w', 'a', 'b', 'c', 'd', 'R_I', 'tau_s']
...
#     test_R_I = 4.
#     params_pop1 = {'a': 0.02, 'b': 0.245, 'c': -64., 'd': 8., 'R_I': test_R_I, 'tau_s': 2.5}
#     weights_std = 0.25
#     hand_coded_params_pop1 = {'preset_weights': (torch.ones((pop_size, 1)) +
#                                                  (2 * weights_std * torch.randn((pop_size, N))) - weights_std) *
...
#     params_pop2 = {'a': 0.02, 'b': 0.25, 'c': -52., 'd': 4., 'R_I': test_R_I, 'tau_s': 2.5}
#     hand_coded_params_pop2 = {'preset_weights': (torch.ones((pop_size, 1)) +
#                                                  (2 * weights_std * torch.randn((pop_size, N))) - weights_std) *
#                                                 # torch.cat([T(4*[.1]), T(4*[.43]), T(4*[0.34])])}
...
#     params_pop3 = {'a': 0.018, 'b': 0.242, 'c': -64., 'd': 2., 'R_I': test_R_I, 'tau_s': 1.5}
#     hand_coded_params_pop3 = {'preset_weights': (torch.ones((pop_size, 1)) +
#                                                  (2 * weights_std * torch.randn((pop_size, N))) - weights_std) *
#                                                 # torch.cat([T(4*[-.16]), T(4*[-.4]), T(4*[-0.12])])}
