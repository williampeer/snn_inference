...
class LIF(nn.Module):
    ...
    parameter_init_intervals = {'E_L': [-50., -48.], 'tau_m': [7., 8.1], 'tau_s': [10., 10.5] }

    def __init__(self, parameters, N=4, w_mean=0.6, w_var=0.2, neuron_types=T([1, 1, -1, -1])):
