...
class LIF_soft(nn.Module):
    ...
    parameter_init_intervals = {'E_L': [-65., -52.], 'tau_m': [1.9, 2.4], 'tau_g': [3., 4.5]}
    ...
    def forward(self, x_in):
        ...
        I = (self.g).matmul(self.self_recurrence_mask * W_syn) + 1.5 * x_in  # assuming input weights to be Eye(N,N)
