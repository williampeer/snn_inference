...
# _, model_spike_times = data_util.get_spike_times_list(index_last_step=0, advance_by_t_steps=time_interval, spike_times=input_times,
#                                                       spike_indices=input_indices, node_numbers=in_node_indices)
_, target_spike_times = data_util.get_spike_times_list(index_last_step=0, advance_by_t_steps=time_interval, spike_times=spike_times,
                                                       spike_indices=spike_indices, node_numbers=spike_node_indices)
