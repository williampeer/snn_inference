...
def main(argv):
    ...
    m2_path = '/Users/william/repos/archives_snn_inference/archive inf 0207-0750/saved/plot_data/07-01_15-49-26-138/plot_spiketrains_side_by_side07-01_16-15-35-707.pt'
    ...
    #                           legend=['Sleep model', 'Fitted model 1', 'Fitted model 2'])
    ...
    std1, r1 = stats.binned_avg_firing_rate_per_neuron(t, bin_size=bin_size)
    std2, r2 = stats.binned_avg_firing_rate_per_neuron(s1, bin_size=bin_size)
    std3, r3 = stats.binned_avg_firing_rate_per_neuron(s2, bin_size=bin_size)
    plot.bar_plot_all_neuron_rates([r1, r2, r3], [std1, std2, std3], bin_size=bin_size, exp_type='default', uuid='export',
                               fname='rate_plot_bin_{}_{}'.format(bin_size, save_fname),
                                   legends=['Sleep model', 'Fitted model 1', 'Fitted model 2'])
