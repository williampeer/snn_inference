...
def main(argv):
    ...
    torch.save(params_by_optim, './saved/single_objective_optim/params_by_optim_optim_{}_loss_fn_{}_budget_{}.pt'.format(optim_name, loss_fn, budget))
    torch.save(exp_min_losses, './saved/single_objective_optim/min_losses_optim_{}_loss_fn_{}_budget_{}.pt'.format(optim_name, loss_fn, budget))
