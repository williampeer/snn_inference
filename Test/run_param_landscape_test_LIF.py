...
plot_param_landscape(LIF, [-70., -40.], [1.5, 10.], 'E_L', 'tau_m', other_parameters, target_spikes, num_steps=num_steps, inputs=current_inputs.clone().detach(), fname_addition='white_noise')
plot_param_landscape(LIF, [-70., -40.], [1., 12.], 'E_L', 'tau_s', other_parameters, target_spikes, num_steps=num_steps, inputs=current_inputs.clone().detach(), fname_addition='white_noise')
plot_param_landscape(LIF, [1.5, 10.], [1., 12.], 'tau_m', 'tau_s', other_parameters, target_spikes, num_steps=num_steps, inputs=current_inputs.clone().detach(), fname_addition='white_noise')
